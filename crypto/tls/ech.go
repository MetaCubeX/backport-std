...
import (
	...
	"github.com/metacubex/backport-std/crypto/internal/hpke"
	"github.com/metacubex/backport-std/slices"
	"github.com/metacubex/backport-std/x/crypto/cryptobyte"
)
...
func encodeInnerClientHello(inner *clientHelloMsg, maxNameLength int) ([]byte, error) {
	...
	var paddingLen int
	if inner.serverName != "" {
		paddingLen = buildin.Max(0, maxNameLength-len(inner.serverName))
	} else {
